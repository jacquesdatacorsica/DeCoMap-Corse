...
knitr::opts_chunk$set( warning = TRUE,  message = FALSE, cache.lazy = FALSE)
...
```{r french, echo=FALSE, cache=TRUE}
...
TC <- table(TEDFR$LOCAL, TEDFR$TYPE_OF_CONTRACT)
    
```
Of course, it varies a lot depending on the type of the contract :

`r round(TC[2]/colSums(TC),2)`
