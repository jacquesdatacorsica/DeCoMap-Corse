...
table1_culture<-TED_CULTURE_FR[,c(1,10,32,57)]
table1_culture%>%datatable(extensions = 'Buttons',
...
table2_culture<-BOAMP_CULTURE[,c(1,3,23)]
table2_culture%>%datatable(extensions = 'Buttons',
          options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                          lengthMenu = list(c(10,25,50,-1),
                                             c(10,25,50,"All"))),rownames = FALSE)
...
table3_culture<-DECP_CULTURE[,c(3,6,35)]
table3_culture%>%datatable(extensions = 'Buttons',
          options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                          lengthMenu = list(c(10,25,50,-1),
                                             c(10,25,50,"All"))),rownames = FALSE)
